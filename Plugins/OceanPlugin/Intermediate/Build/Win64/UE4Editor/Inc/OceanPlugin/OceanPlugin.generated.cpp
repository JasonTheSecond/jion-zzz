...
// Cross Module References
	...
	OCEANPLUGIN_API class UScriptStruct* Z_Construct_UScriptStruct_FForceTriangle();
	OCEANPLUGIN_API class UScriptStruct* Z_Construct_UScriptStruct_FBuoyancyVertex();
	OCEANPLUGIN_API class UFunction* Z_Construct_UFunction_UAdvancedBuoyancyComponent_ApplyForce();
	OCEANPLUGIN_API class UFunction* Z_Construct_UFunction_UAdvancedBuoyancyComponent_ApplySlamForce();
	OCEANPLUGIN_API class UFunction* Z_Construct_UFunction_UAdvancedBuoyancyComponent_DrawDebugStuff();
	OCEANPLUGIN_API class UFunction* Z_Construct_UFunction_UAdvancedBuoyancyComponent_GetOcean();
	OCEANPLUGIN_API class UFunction* Z_Construct_UFunction_UAdvancedBuoyancyComponent_GetOceanDepthFromGrid();
	OCEANPLUGIN_API class UFunction* Z_Construct_UFunction_UAdvancedBuoyancyComponent_SetMeshDensity();
	OCEANPLUGIN_API class UFunction* Z_Construct_UFunction_UAdvancedBuoyancyComponent_SplitTriangle();
	OCEANPLUGIN_API class UFunction* Z_Construct_UFunction_UAdvancedBuoyancyComponent_TriangleArea();
	OCEANPLUGIN_API class UClass* Z_Construct_UClass_UAdvancedBuoyancyComponent_NoRegister();
	OCEANPLUGIN_API class UClass* Z_Construct_UClass_UAdvancedBuoyancyComponent();
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(AOceanManager, 1027531582);
...
class UScriptStruct* FForceTriangle::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern OCEANPLUGIN_API class UScriptStruct* Z_Construct_UScriptStruct_FForceTriangle();
...
static struct FScriptStruct_OceanPlugin_StaticRegisterNativesFForceTriangle
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FForceTriangle_CRC() { return 533240500U; }
class UScriptStruct* FBuoyancyVertex::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern OCEANPLUGIN_API class UScriptStruct* Z_Construct_UScriptStruct_FBuoyancyVertex();
...
static struct FScriptStruct_OceanPlugin_StaticRegisterNativesFBuoyancyVertex
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FBuoyancyVertex_CRC() { return 3362327973U; }
	...
	UFunction* Z_Construct_UFunction_UAdvancedBuoyancyComponent_ApplyForce()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("ApplyForce"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(AdvancedBuoyancyComponent_eventApplyForce_Parms));
	...
	UFunction* Z_Construct_UFunction_UAdvancedBuoyancyComponent_ApplySlamForce()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("ApplySlamForce"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04820401, 65535, sizeof(AdvancedBuoyancyComponent_eventApplySlamForce_Parms));
	...
	UFunction* Z_Construct_UFunction_UAdvancedBuoyancyComponent_DrawDebugStuff()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("DrawDebugStuff"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04820401, 65535, sizeof(AdvancedBuoyancyComponent_eventDrawDebugStuff_Parms));
	...
	UFunction* Z_Construct_UFunction_UAdvancedBuoyancyComponent_GetOcean()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("GetOcean"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UAdvancedBuoyancyComponent_GetOceanDepthFromGrid()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("GetOceanDepthFromGrid"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04820401, 65535, sizeof(AdvancedBuoyancyComponent_eventGetOceanDepthFromGrid_Parms));
			...
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bJustGetHeightAtLocation, AdvancedBuoyancyComponent_eventGetOceanDepthFromGrid_Parms, bool);
	...
	UFunction* Z_Construct_UFunction_UAdvancedBuoyancyComponent_SetMeshDensity()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetMeshDensity"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(AdvancedBuoyancyComponent_eventSetMeshDensity_Parms));
	...
	UFunction* Z_Construct_UFunction_UAdvancedBuoyancyComponent_SplitTriangle()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SplitTriangle"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04820401, 65535, sizeof(AdvancedBuoyancyComponent_eventSplitTriangle_Parms));
	...
	UFunction* Z_Construct_UFunction_UAdvancedBuoyancyComponent_TriangleArea()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("TriangleArea"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04820401, 65535, sizeof(AdvancedBuoyancyComponent_eventTriangleArea_Parms));
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				...
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bDebugOn, UAdvancedBuoyancyComponent, bool);
				...
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bUseDrag, UAdvancedBuoyancyComponent, bool);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAdvancedBuoyancyComponent_ApplyForce(), "ApplyForce"); // 14315289
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAdvancedBuoyancyComponent_ApplySlamForce(), "ApplySlamForce"); // 3597667577
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAdvancedBuoyancyComponent_DrawDebugStuff(), "DrawDebugStuff"); // 250609099
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAdvancedBuoyancyComponent_GetOcean(), "GetOcean"); // 348507359
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAdvancedBuoyancyComponent_GetOceanDepthFromGrid(), "GetOceanDepthFromGrid"); // 2348385447
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAdvancedBuoyancyComponent_SetMeshDensity(), "SetMeshDensity"); // 3490053051
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAdvancedBuoyancyComponent_SplitTriangle(), "SplitTriangle"); // 232083963
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAdvancedBuoyancyComponent_TriangleArea(), "TriangleArea"); // 427990580
	...
	IMPLEMENT_CLASS(UAdvancedBuoyancyComponent, 3477452043);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(UBuoyancyComponent, 4161693391);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(UBuoyancyForceComponent, 609608738);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(UBuoyantDestructibleComponent, 2079257305);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(ABuoyantDestructible, 1555468747);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(UBuoyantMeshComponent, 3764955040);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(ACustomVehicleController, 1178603886);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(AFishManager, 6377526);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(AFlockFish, 1112896931);
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFollowMethod(EFollowMethod_StaticEnum, TEXT("/Script/OceanPlugin"), TEXT("EFollowMethod"), false, nullptr, nullptr);
	...
	uint32 Get_Z_Construct_UEnum_OceanPlugin_EFollowMethod_CRC() { return 2770801905U; }
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(UInfiniteSystemComponent, 2304841978);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(ATimeManager, 2541324368);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	IMPLEMENT_CLASS(UWaterHeightmapComponent, 1872508805);
	...
	UPackage* Z_Construct_UPackage__Script_OceanPlugin()
	{
		...
		if (!ReturnPackage)
		{
			ReturnPackage = CastChecked<UPackage>(StaticFindObjectFast(UPackage::StaticClass(), nullptr, FName(TEXT("/Script/OceanPlugin")), false, false));
